  ...
  methods: {
    ...
    save: function save() {
      sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
        icon: 'warning',
        title: _plugins_i18n__WEBPACK_IMPORTED_MODULE_4__["default"].t('Validator не атработал'),
        text: _plugins_i18n__WEBPACK_IMPORTED_MODULE_4__["default"].t('Причина'),
        reverseButtons: true,
              ...
              _c(
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      _c("eva-icon", {
                        attrs: { name: "plus-outline", width: 14, height: 14 }
                      }),
                      _vm._v(
                        "\n                        add var\n                    "
                      )
